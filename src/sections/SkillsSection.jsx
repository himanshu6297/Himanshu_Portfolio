    ...
    <section id="skills" className="section bg-white">
      <div className="section-container">
        <div className="mb-16 text-center animate-fade-in">
          <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-4">Skills & Technologies</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {skillCategories.map((category, idx) => (
            <div
              ...
              className="group p-6 rounded-xl bg-white border-2 border-gray-100 hover:border-primary-300 hover:shadow-lg transition-all duration-300 animate-slide-up"
