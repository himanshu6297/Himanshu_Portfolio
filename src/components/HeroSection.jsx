...
export default function HeroSection() {
  return (
    <section
      id="home"
      className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center pt-20"
    >
      <div className="section-container">
        <div className="max-w-3xl animate-fade-in">
          <div className="mb-6 inline-block px-4 py-2 bg-primary-100 rounded-full">
            <span className="text-primary-600 font-semibold text-sm">Welcome to my portfolio</span>
          </div>
          ...
          <p className="text-xl text-gray-700 mb-8 leading-relaxed animate-slide-up" style={{ animationDelay: '0.2s' }}>
